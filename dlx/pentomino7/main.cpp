...
int main (int argc, char **argv) {
	...
	m.add_columns( { "21", "22", "23", "24", "25",       "27", "28" } );
	m.add_columns( { "31", "32", "33", "34", "35", "36",       "38" } );
	m.add_columns( { "41", "42", "43", "44", "45", "46", "47", "48" } );
	m.add_columns( { "51", "52", "53", "54", "55", "56", "57", "58" } );
	m.add_columns( { "61",       "63", "64", "65", "66", "67", "68" } );
	m.add_columns( { "71", "72",       "74", "75", "76", "77", "78" } );
