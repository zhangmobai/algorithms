...
void setup_pentiminoes1(matrix &m) {
	m.add_row( { "F", "25", "34", "35", "36", "46" });
	m.add_row( { "I", "41", "51", "61", "71", "81" });
	m.add_row( { "L", "17", "18", "28", "38", "48" });
	m.add_row( { "P", "76", "77", "85", "86", "87" });
	m.add_row( { "N", "14", "15", "16", "26", "27" });
	m.add_row( { "T", "37", "47", "56", "57", "58" });
	m.add_row( { "U", "11", "12", "21", "31", "32" });
	m.add_row( { "V", "66", "67", "68", "78", "88" });
	m.add_row( { "W", "65", "74", "75", "83", "84" });
	m.add_row( { "X", "13", "22", "23", "24", "33" });
	m.add_row( { "Y", "52", "62", "72", "73", "82" });
	m.add_row( { "Z", "42", "43", "53", "63", "64" });
}
...
void setup_pentiminoes(matrix &m) {
	for (unsigned int i = 0; i != N_PENTO; ++i) {
		...
		if (p.name == "X") {
			//m.add_row( { "X", "13", "22", "23", "24", "33" } );
			//m.add_row( { "X", "14", "23", "24", "25", "34" } );
			m.add_row( { "X", "23", "32", "33", "34", "43" } );
			continue;
		}
#endif
...
int main (int argc, char **argv) {
	...
	m.add_columns( { "31", "32", "33", "34", "35", "36", "37", "38" } );
	m.add_columns( { "41", "42", "43",             "46", "47", "48" } );
	m.add_columns( { "51", "52", "53",             "56", "57", "58" } );
	m.add_columns( { "61", "62", "63", "64", "65", "66", "67", "68" } );
